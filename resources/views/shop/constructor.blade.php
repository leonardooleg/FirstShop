                ...
                <div class="product__top-block">
                    <div class="row">
                        ...
                        <div class="col-md-7" id="product_images">
                                        ...
                                        <div class="swiper-container swiper-container-vertical" id="swiper-thumbnails">
                                            <div class="swiper-wrapper" style="">
                                                <div class="swiper-slide swiper-slide-active" data-image-id="" style="height: 75px; margin-bottom: 3px;">
                                                    <a href="#">
                                                        <img src="" alt="" data-img-big="" data-pos="0" onload="if(window.img_tracker){window.img_tracker.track.apply(window.img_tracker, [event, 'loaded'])}" onerror="if(window.img_tracker){window.img_tracker.track.apply(window.img_tracker,[event, 'failed'])}">
                                                    </a>
                                                </div>
                                ...
                                <div class="col-md-9">
                                    <div class="product__image preview">
                                        ...
                                        <div class="item-image hidden-xs">
                                            <a class="zoom" href="#">
                                                <img src="" class="main-image" itemprop="image" title="Мужская футболка 3D Queen. Bohemian Rhapsody Фото 01">
                            ...
                            <div class="hidden hidden-holder"><a class="fancyinline" rel="group" href="" data-pos="0"></a>
                                <a class="fancyinline" rel="group" href="" data-pos="1"></a>
