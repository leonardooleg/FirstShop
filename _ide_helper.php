 ...
 * Generated for Laravel 5.8.21 on 2019-08-17 13:21:30.
 *
...
namespace Darryldecode\Cart\Facades {
    ...
    class CartFacade {
         ...
         * @static
         */
        public static function add($cart_id, $id, $name = null, $price = null, $quantity = null, $attributes = array(), $conditions = array())
        {
                        /** @var \Darryldecode\Cart\Cart $instance */
                        return $instance->add($cart_id, $id, $name, $price, $quantity, $attributes, $conditions);
        }
        ...
        {
                        /** @var \Darryldecode\Cart\Cart $instance */
                        return $instance->update($cart_id, $data);
        }
        ...
        {
                        /** @var \Darryldecode\Cart\Cart $instance */
                        return $instance->remove($cart_id);
        }
